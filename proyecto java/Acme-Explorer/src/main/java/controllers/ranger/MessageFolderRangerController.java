...
@Controller
@RequestMapping("/messageFolder/ranger")
public class MessageFolderRangerController extends AbstractController {
	...
	public MessageFolderRangerController() {
		super();
	}
	...
	public ModelAndView list() {
		...
		result.addObject("requestURI", "messageFolder/ranger/list.do");
	...
	protected ModelAndView createEditModelAndView(MessageFolder messageFolder, String messageCode) {
		...
		result.addObject("requestURI", "messageFolder/ranger/edit.do");
