...
@Controller
@RequestMapping("/messageFolder/manager")
public class MessageFolderManagerController extends AbstractController {
	...
	public MessageFolderManagerController() {
		super();
	}
	...
	public ModelAndView list() {
		...
		result.addObject("requestURI", "messageFolder/manager/list.do");
	...
	public ModelAndView save(@Valid MessageFolder messageFolder, BindingResult bindingResult) {
		...
		if (bindingResult.hasErrors())
			...
			try {
				...
				result = new ModelAndView("redirect:/messageFolder/manager/list.do");
	...
	protected ModelAndView createEditModelAndView(MessageFolder messageFolder, String messageCode) {
		...
		result.addObject("requestURI", "messageFolder/manager/edit.do");
