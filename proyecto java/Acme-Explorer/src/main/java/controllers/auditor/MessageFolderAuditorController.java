...
@Controller
@RequestMapping("/messageFolder/auditor")
public class MessageFolderAuditorController extends AbstractController {
	...
	public MessageFolderAuditorController() {
		super();
	}
	...
	public ModelAndView list() {
		...
		result.addObject("requestURI", "messageFolder/auditor/list.do");
